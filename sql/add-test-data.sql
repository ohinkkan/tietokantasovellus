...
INSERT INTO task (name,descr,priority_id,dbuser_id) VALUES 
('workwork','work a lot',1,1),
('workwork2','work a lots',2,1),
('workwork3','work a lotz',2,1),
('workworkwork','work a loads',3,2),
('workworkworkwork','work a loooot',4,2);
